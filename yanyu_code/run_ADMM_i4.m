...
save('objs_coor_container.mat', 'objs_coor_container_i3')
save('objs_prox_container.mat', 'objs_prox_container_i3')
save('objs_owlqn_container.mat', 'objs_owlqn_container_i3')
